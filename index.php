...
<body>
    ...
    {
        // navbar con el style.css
        echo "<div class='navbar'>";
        echo "<a href='?vista=FAQ'>FAQ</a>";
        echo "<a href='?vista=productos'>Productos</a>";
        echo "<a href='?vista=vision'>Visión</a>";
        echo "<a href='?vista=mision'>Misión</a>";
        echo "<a href='?vista=inicio'>Inicio</a>";
